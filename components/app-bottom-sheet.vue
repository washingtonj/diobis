...
<template>
  <div
    :id="$props.id"
    class="fixed w-full rounded-t-xl bottom-0 left-0 p-8 pt-4 backdrop-blur bg-blue-50/75 border-t-2 border-blue-600 dark:bg-slate-900/75 dark:text-white text-black"
  >
